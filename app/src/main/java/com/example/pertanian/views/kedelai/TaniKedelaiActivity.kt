...
import com.example.pertanian.viewmodels.kedelai.TaniKedelaiViewModel
import kotlinx.android.synthetic.main.activity_tani_jagung.*

class TaniKedelaiActivity : AppCompatActivity(), TaniRcyAdapter.OnItemClickListener {

    lateinit var taniRcyAdapter: TaniRcyAdapter
    lateinit var taniKedelaiViewModel: TaniKedelaiViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.title = "Produktivitas Kedelai"
        ...
        btnAddPerikanan.setOnClickListener {
            val intent = Intent(this, TambahEditKedelaiActivity::class.java)
    ...
    private fun initViewModel() {
        taniKedelaiViewModel = ViewModelProvider(this).get(TaniKedelaiViewModel::class.java)
        taniKedelaiViewModel.getKedelaiLiveObserveable().observe(this, Observer<PertanianList>{
            if(it == null){
                Toast.makeText(this@TaniKedelaiActivity, "No result found", Toast.LENGTH_LONG).show()
            }else{
        ...
        editTextPerikananSearch.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
               if(s!!.length > 0){
                   ...
                   taniRcyAdapter.notifyDataSetChanged()
                   taniKedelaiViewModel.getKedelaiList(s.toString())
               }else{
                   taniRcyAdapter.taniList.clear()
                   taniRcyAdapter.notifyDataSetChanged()
                   taniKedelaiViewModel.getKedelaiList("")
               }
            }
    ...
    private fun initRecyclerView() {
        rcyPerikanan.apply {
            layoutManager = LinearLayoutManager(this@TaniKedelaiActivity)
            taniRcyAdapter = TaniRcyAdapter(this@TaniKedelaiActivity)
